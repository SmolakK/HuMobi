...
def _generate_agent(cluster_id, sig_locations, activity_area, circadian_rhythm, temporal_mechanism=None, spatial_mechanism=None):
    return Agent(sig_locs=sig_locations, temporal_mechanism=temporal_mechanism, spatial_mechanism=spatial_mechanism,
                 cluster=cluster_id, activity_area=activity_area, circadian_rhythm=circadian_rhythm)


def generate_agents(n_agents, cluster_id, list_home, list_work, list_geometry, circadian_rhythm):
    """
    ...
    Args:
        ...
        circadian_rhythm: circadian rhythm of an agent
    ...
    for n in range(n_agents):
        agents.append(_generate_agent(cluster_id=cluster_id, sig_locations=sig_locs.iloc[n, :],
                                      activity_area=list_geometry[n], circadian_rhythm=circadian_rhythm,
                                      temporal_mechanism='simple', spatial_mechanism='simple'))
    return agents
