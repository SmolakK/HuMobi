...
def markovian_sequences_generator(users,places,length,prob):
	...
	:param users: The number of users (sequences) to generate.
	:param places: The number of unique places (symbols) to choose from. Can be a range or list to randomly choose from.
	:param length: The length of sequences. Can be a range or list to randomly choose from.
	:param prob: The $p$ value determining the probability of generator following the deterministic sequence.
	Can be a range or list to randomly choose from.
	:return: A DataFrame with synthetic Markovian sequences.
	"""
	...
	generated_frame.columns = ['userid', 'datetime', 'labels']
...
def random_sequences_generator(users,places,length):
	...
	:param places: The number of unique places (symbols) to choose from. Can be a range or list to randomly choose from.
	:param length: The length of sequences. Can be a range or list to randomly choose from.
	:return: A DataFrame with synthetic random sequences.
	"""
	if isinstance(places,list):
		places = np.random.choice(places,users)
	else:
...
def deterministic_sequences_generator(users,places,repeats):
	...
	:param users: The number of users (sequences) to generate.
	:param places: The number of unique places (symbols) to choose from. Can be a range or list to randomly choose from.
	:param repeats: The number of repeats determining the lenght of sequences. Can be a range or list to randomly choose
	from.
	:return: A DataFrame with synthetic deterministic sequences.
	"""
	if isinstance(places,list):
		places = np.random.choice(places,users)
	else:
...
def exploratory_sequences_generator(users, places):
	...
	:param users: The number of users (sequences) to generate.
	:param places: The number of unique places (symbols) to choose from. Also determine the legnth of the sequence.
	Can be a range or list to randomly choose from.
	:return: A DataFrame with synthetic exploratory sequences.
	"""
	if isinstance(places,list):
		places = np.random.choice(places,users)
	else:
...
def self_transitions_sequences_generator(users,places,length):
	...
	:param places: The number of unique places (symbols) to choose from. Can be a range or list to randomly choose from.
	:param length: The length of sequences. Can be a range or list to randomly choose from.
	:return: A DataFrame with synthetic self-transitions sequences.
	"""
	if isinstance(places,list):
		places = np.random.choice(places,users)
	else:
...
def non_stationary_sequences_generator(users, places, states, length):
	...
	:param users: The number of users (sequences) to generate.
	:param places: The number of unique places (symbols) to choose from. Can be a range or list to randomly choose from.
	:param states: The number of states with different generation routine. Can be a range or list to randomly choose 
	from.
	:param length: The length of sequences. Can be a range or list to randomly choose from.
	:return: A DataFrame with synthetic non-stationary sequences.
	"""
	if isinstance(places,list):
		places = np.random.choice(places,users)
	else:
