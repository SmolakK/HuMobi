...
clust_agg = LayerAggregator("D:\\Projekty\\4W\\census_tracts\\rj_sectors.shp",kwargs={})
...
# df_sel = TrajectoriesFrame("""D:\\Projekty\\4W\\sample_processed.csv""",{'names':['user_id','datetime','temp','lat','lon','labels',
#                                                                                     'start','end','geometry'],'skiprows':1, 'crs': 3856})
