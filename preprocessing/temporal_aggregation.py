...
class TemporalAggregator():
	...
	def __init__(self, resolution):
		...
		:param resolution: resolution to which data will be aggregated
		"""
	...
	def _user_aggregate(self, uid, single_user):
		...
		:param single_user: user's trajectory
		:return: aggregated trajectory
		"""
	...
	def aggregate(self, trajectories_frame, fill_method = None, drop_empty = False, parralel = True):
		"""
		...
		:param fill_method: Empty records filling method, if 'None' then data is not filled in. Any other value causes use of forward fill.
		:param drop_empty: If empty records should be removed. Default is False.
		:param parralel: If parralel computing should be used. Default is True.
		:return: temporally aggregated TrajectoriesFrame
		"""
